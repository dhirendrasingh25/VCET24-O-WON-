    ...
    const handleAnswer = () => {
        if (selectedAnswer !== null) {
            ...
            if (currentQuestion < quizData.quiz.length - 1) {
                ...
                const score = newResponses.reduce(
                    (sum, response) => sum + response.points,
                    0,
                );
                setTotalScore(score);
                submitQuiz(
                    JSON.stringify({ responses: newResponses }, null, 2),
                );
            }
        }
    };
                    ...
                    <CardContent>
                        <div className="mb-6">
                            <h3 className="text-lg font-semibold mb-2">
                                ...
                                {getFinancialHealthStatus(totalScore)}
                            </h3>
                            <p className="text-sm sm:text-base mb-4">
                                Based on your responses, your financial health
                                score is {totalScore} out of{" "}
                        ...
                        >
                            ...
                            <p>
                                Our platform offers personalized tools and
                                advice to help you improve your financial
                                health. Start your journey to financial freedom
                                today!
                            </p>
                        </div>
                    </CardContent>
