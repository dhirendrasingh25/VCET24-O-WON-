...
import {
  ...
  Join Us Now !
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Continue with your feasibility</AlertDialogTitle>
            <AlertDialogDescription>
            <div className="h-full my-3 mb-8 w-full flex sm:flex-row flex-col space-y-3 sm:space-y-1 space-x-0 sm:space-x-3">
                     ...
                     className="p-6 font-semibold "
                            ...
                            >
                                <FaInternetExplorer className="text-3xl mx-3" />Continue with Web
                            </Button>
               
              
                <Button className="p-6 font-semibold ">
                  <MdOutlineInstallMobile className="text-3xl mx-3"/>  Download App
                </Button>
            </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
