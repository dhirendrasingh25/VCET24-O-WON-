...
const achievements = [
    ...
    },
    {
        id: 4,
        name: "Big Spender",
        description: "Make a single transaction of ₹10,000 or more",
        target: 10000,
        type: "maxTransaction",
        score: 15,
    },
    {
        id: 5,
        name: "Money Mover",
        description: "Reach ₹100,000 in total transactions",
        target: 100000,
        type: "totalAmount",
        score: 30,
    },
    ...
    },
    {
        id: 7,
        name: "Mega Purchase",
        description: "Make a single transaction of ₹50,000 or more",
        target: 50000,
        type: "maxTransaction",
        score: 30,
    },
    ...
    },
    {
        id: 9,
        name: "Financial Flux",
        description: "Reach ₹500,000 in total transactions",
        target: 500000,
        type: "totalAmount",
        score: 50,
    },
...
const coupons = [
    ...
    {
        id: 2,
        name: "Free financial consultation",
        code: "CONSULT2023",
        minScore: 100,
    },
    {
        id: 3,
        name: "₹500 bonus on ₹10,000 savings",
        code: "SAVE500",
        minScore: 150,
    },
    {
        id: 4,
        name: "Premium features free for 1 month",
        code: "PREMIUM1MONTH",
        minScore: 200,
    },
];
        ...
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8">
            ...
            <div className="mb-8 bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-center">
                    {completedPercentage.toFixed(1)}% Completed
                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                {achievements.map((achievement) => (
                    <div
                        key={achievement.id}
                        className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center transition-all duration-300 hover:shadow-lg"
                    >
                        <Trophy
                            className={`w-12 h-12 mb-4 ${isAchievementCompleted(achievement) ? "text-yellow-400" : "text-gray-400"}`}
                        />
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {coupons.map((coupon) => (
                        <div
                            key={coupon.id}
                            className={`border rounded-lg p-4 flex items-center ${isCouponUnlocked(coupon) ? "border-green-500" : "border-gray-300"}`}
                        >
                            ...
                            <div>
                                ...
                                {isCouponUnlocked(coupon) ? (
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Unlock at {coupon.minScore} points
                                    </p>
                                )}
                            </div>
                        </div>
