...
async function generateInvestmentTips() {
  ...
  const prompt = "Give me best and top 3 investment plans for todays date in json form. each having name and desc and no other key.just the json having three plans nothing else.also no backtick and json should be written";
